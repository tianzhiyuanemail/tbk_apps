class ProductEntity {
	...
	String estimatedRevenueAmount;
	String pictUrl;
	dynamic tmallPlayActivityInfo;
	String realPostFee;
	...
	ProductEntity({this.commissionRate, this.reservePrice, this.whiteImage, this.includeDxjh, this.numIid, this.shortCouponShareUrl, this.shortTitle, this.couponId, this.title, this.categoryName, this.couponShareUrl, this.zkFinalPrice, this.nick, this.smallImages, this.couponAmount, this.xid, this.sellerId, this.tkTotalSales, this.couponStartTime, this.shopDsr, this.itemDescription, this.includeMkt, this.levelOneCategoryId, this.tkTotalCommi, this.couponStartFee, this.couponRemainCount, this.levelOneCategoryName, this.couponInfo, this.afterCouponPrice, this.pictUrl, this.tmallPlayActivityInfo, this.realPostFee, this.commissionType, this.url, this.couponEndTime, this.couponTotalCount, this.volume, this.itemId, this.infoDxjh, this.provcity, this.shopTitle, this.couponPrice, this.userType, this.itemUrl, this.categoryId});
	...
	ProductEntity.fromJson(Map<String, dynamic> json) {
		...
		numIid = json['numIid'];
		shortCouponShareUrl = json['shortCouponShareUrl'];
		...
		estimatedRevenueAmount = json['estimatedRevenueAmount'];
	...
	Map<String, dynamic> toJson() {
		...
		data['shortCouponShareUrl'] = this.shortCouponShareUrl;
		...
		data['estimatedRevenueAmount'] = this.estimatedRevenueAmount;
