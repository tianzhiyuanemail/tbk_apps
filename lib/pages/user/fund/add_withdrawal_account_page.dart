...
import 'package:tbk_app/widgets/store_select_text_item.dart';
import 'package:tbk_app/widgets/text_field_item.dart';
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          StoreSelectTextItem(
                            ...
                            onTap: () {
                              NavigatorUtil.pushResult(context,  Routers.citySelectPage, (result){
                                setState(() {
                          ...
                          StoreSelectTextItem(
                            ...
                            onTap: () {
                              NavigatorUtil.pushResult(context, '${Routers.bankSelectPage}?type=0', (result){
                                setState(() {
                          ...
                          StoreSelectTextItem(
                            ...
                            onTap: () {
                              NavigatorUtil.pushResult(context, '${Routers.bankSelectPage}?type=1', (result){
                                setState(() {
                                  BankModel model = result;
