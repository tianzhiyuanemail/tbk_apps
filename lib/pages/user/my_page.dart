...
import 'package:tbk_app/widgets/gzx_card.dart';
import 'package:tbk_app/widgets/package_info.dart';
import 'package:tbk_app/widgets/pull_load/ListState.dart';
...
class _MyPageState extends State<MyPage>
  ...
  Widget build(BuildContext context) {
    ...
    // 如果不加这句，从子页面回来会重新加载didChangeDependencies()方法
    super.build(context);
