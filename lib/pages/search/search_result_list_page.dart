...
class SearchResultListPage extends StatefulWidget {
  ...
  SearchResultListPage({this.searchText});

  @override
  _SearchResultListPage createState() => _SearchResultListPage();
}

class _SearchResultListPage extends State<SearchResultListPage>
